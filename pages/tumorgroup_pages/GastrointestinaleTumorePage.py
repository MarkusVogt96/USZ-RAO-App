...
class GastrointestinaleTumorePage(QWidget):
    group_name = "Gastrointestinale Tumore"
    
    def __init__(self, main_window):
        super().__init__()
        logging.info("Initializing GastrointestinaleTumorePage...")
        self.main_window = main_window
        self.setup_ui()
        logging.info("GastrointestinaleTumorePage UI setup complete.")
    ...
    def setup_ui(self):
        ...
        entities = [
            "Ösophagus-Ca", "HCC", "CCC", "Pankreas-Ca", "Rektum-Ca", "Anal-Ca"
        ]
