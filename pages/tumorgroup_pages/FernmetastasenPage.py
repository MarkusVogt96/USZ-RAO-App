...
class FernmetastasenPage(QWidget):
    group_name = "Fernmetastasen"
    
    def __init__(self, main_window):
        super().__init__()
        logging.info("Initializing FernmetastasenPage...")
        self.main_window = main_window
        self.setup_ui()
        logging.info("FernmetastasenPage UI setup complete.")
