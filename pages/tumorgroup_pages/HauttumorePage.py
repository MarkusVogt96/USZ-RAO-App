...
class HauttumorePage(QWidget):
    group_name = "Hauttumore"
    
    def __init__(self, main_window):
        super().__init__()
        logging.info("Initializing HauttumorePage...")
        self.main_window = main_window
        self.setup_ui()
        logging.info("HauttumorePage UI setup complete.")
    ...
    def setup_ui(self):
        ...
        entities = [
             "BCC und cSCC", "Melanom", "Merkelzell-Ca"
        ]
