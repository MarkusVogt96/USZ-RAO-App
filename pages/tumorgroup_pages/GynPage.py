...
class GynPage(QWidget):
    group_name = "Gynäkologische Tumore"
    
    def __init__(self, main_window):
        super().__init__()
        logging.info("Initializing GynPage...")
        self.main_window = main_window
        self.setup_ui()
        logging.info("GynPage UI setup complete.")
    ...
    def setup_ui(self):
        ...
        entities = [
            "Mamma-Ca", "Endometrium-Ca", "Cervix-Ca", "Vulva-Ca"
        ]
