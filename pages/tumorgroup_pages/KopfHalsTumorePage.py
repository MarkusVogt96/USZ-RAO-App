...
class KopfHalsTumorePage(QWidget):
    group_name = "Kopf-Hals-Tumore" # Define group name for the class
    
    def __init__(self, main_window):
        super().__init__()
        logging.info("Initializing KopfHalsTumorePage...")
        self.main_window = main_window
        self.setup_ui()
        logging.info("KopfHalsTumorePage UI setup complete.")
    ...
    def setup_ui(self):
        ...
        entities = [
            "Nasenkarzinom", "Nasopharynxkarzinom", "Larynx und Hypopharynx", 
            "Oropharynxkarzinom", "Speicheldrüsenkarzinom"
        ]
