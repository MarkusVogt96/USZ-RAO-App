...
class ContouringPage(QWidget):
    def __init__(self, main_window, tumor_type, group_name):
        ...
        logging.info(f"Initializing ContouringPage for: {self.tumor_type} (Group: {self.group_name})")
        self.setup_ui()
        logging.info(f"ContouringPage UI setup complete for {self.tumor_type}.")
