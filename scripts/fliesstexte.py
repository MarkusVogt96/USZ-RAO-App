...
def define_berrao_texte(bericht_typ, entity, patdata, glossary):
    ...
    if bericht_typ == "e":
        ...
        texte["fliesstext_beurteilung"] = (f"Im Rahmen der heutigen Erstkonsultation haben wir mit {g('artikel_dativ_klein','dem/der')} {g('patient_dativ','Patienten/in')} ausführlich über mögliche radioonkologische Therapieoptionen"
                                  ...
                                  f"\n\nInsbesondere erläuterten wir {g('artikel_dativ_klein','dem/der')} {g('patient_dativ','Patienten/in')} die mögliche Bestrahlung der {therapieintention_klein}n Bestrahlung des {konzept_alle_serien} mit dem Ziel einer verbesserten lokalen Tumorkontrolle und Vermeiden von Symptomexazerbation bei weiterem Tumorwachstum. Die radioonkologische Therapie würde sich entsprechend über einen Zeitraum von ca. _____ Wochen erstrecken."
